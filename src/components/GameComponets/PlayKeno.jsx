        ...
        <div className='p-2 md:p-6'>
            <div className='flex flex-wrap gap-3'>
              <div className=" flex gap-[3px] md:gap-[10px]">
                ...
                <div className="grid gap-[3px] md:gap-[10px]">
                <div className='w-[106.83px] h-[24.77px] md:w-[157px] md:h-8 bg-dark-green flex text-center justify-center items-center rounded-md text-white uppercase text-sm font-rubik'>min</div>
                ...
                <div className=' w-full md:w-[279px] h-[73px] bg-primary-game hover:bg-dark-green rounded-md text-white text-4xl flex justify-center items-center cursor-pointer select-none font-rubik uppercase'>
                    play
                </div>
            </div>
        </div>
