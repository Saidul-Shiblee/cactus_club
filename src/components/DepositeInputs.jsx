...
const DepositeInputs = ({ balance, wallet, }) => {
  ...
  const [line1, line2] = textTwoLines(wallet?.data?.wallet);
          ...
          <div ref={dropdownRef} className=" ">
            <div className="relative h-[54px] md:h-[72px]">
              <button
                ...
                className="cursor-pointer relative w-full h-full px-[20px] md:px-[40px]  text-left bg-orange-primary rounded-[20px] shadow-lg  md:text-base font-bold text-primary-title focus:outline-none sm:text-sm"
              >
              ...
              {isDropdownOpen && (
                ...
                >
                  <ul className="py-1 overflow-auto text-base rounded-md max-h-56 focus:outline-none sm:text-sm">
                    ...
                    >
                      <span className="flex items-center h-[40px] mx-[20px] md:mx-[40px]">
                        <img src={Icon2} alt="Icon" />
                    ...
                    >
                      <span className="flex items-center h-[40px] mx-[20px] md:mx-[40px] mb-[4px] ">
                        <img src={Icon3} alt="Icon" />
          ...
          <div className="rounded-[20px] pr-[20px] md:pr-[40px] h-[54px] md:h-[72px] bg-orange-primary cactus-text-color font-poppins text-[16px] font-black placeholder:text-primary-title focus:outline-none border-r-2 flex justify-between">
            <div className="flex items-center">
              <p
                id="deposite"
                ref={inputRef}
                className="md:w-full rounded-[20px] bg-orange-primary px-[20px] md:px-[40px] text-[12px] md:text-base overflow-hidden "
              >{line1}{line2 && <br className="sm:hidden" />} {line2}</p>
